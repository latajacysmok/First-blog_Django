...
urlpatterns = [
    ...
    url(r'^new_song/$', views.song_new, name='song_new'),
    ...
    url(r'^delete_song/(?P<id>\d+)/$', views.delete_song, name='delete_song'),
    url(r'^edit_song/(?P<id>\d+)/$', views.edit_song, name='edit_song'),
